<?php
	/*
		этот файл команды для бота, как добавить свою команду спроси у меня в лс, function можешь узнать у дадаря
		как ей пользоваться, поэтому здесь можешь ничего не трогать и да на линии 90 посмотри как подключить и работать с MySQL
	*/
